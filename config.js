// Supabase Configuration - TRULY IDEMPOTENT
// 100% safe to load multiple times
...
(function() {
    ...
    // Make globally available (safe because we're not using const/let/var at global scope)
    window.supabase = window.supabaseClient;
    window.stripe = window.stripeClient;
})();
