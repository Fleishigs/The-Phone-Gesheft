...
exports.handler = async (event) => {
  ...
  if (stripeEvent.type === 'checkout.session.completed') {
    ...
    try {
      ...
      // Save order to database with status "pending_shipment"
        ...
        .insert([
          {
            ...
            status: 'pending_shipment', // CHANGED FROM 'completed'
      ...
      return { statusCode: 200, body: 'Order created successfully' };
    } catch (err) {
  ...
  if (stripeEvent.type === 'charge.refunded') {
    ...
    try {
      ...
      return { statusCode: 200, body: 'Order marked as refunded' };
    } catch (err) {
